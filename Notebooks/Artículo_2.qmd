...
Al notar que era imposible obtener un buen modelo de redes bayesianas gaussianas utilizando variables discretas se decidió eliminarlas por las razones ya mencionadas anteriormente. Con base en esto, se modificaron las DAG's planteadas anteriormente, de tal manera que surgieron las siguientes:

**DAG 1 modificada**
![Grafo acíclico dirigido 1 con reducción de nodos](nuevadag1.jpg)
**DAG 2 modificada**
![Grafo acíclico dirigido 2 con reducción de nodos](nuevadag2.jpg)
**DAG 3 modificada**
![Grafo acíclico dirigido 3 con reducción de nodos](nuevadag3.jpg)


### Selección del modelo

Al comparar los valores obtenidos, se eligió el **Modelo 2 actualizado**, ya que presentó el **BIC y AIC más alto**, lo que indica un mejor equilibrio entre ajuste del modelo y complejidad.  
...
## Resultado ajuste no paramétrico  
El ajuste no paramétrico obtuvo:

| Modelo                         | \(BIC\) |
|--------------------------------|-------------------------------|
| DAG con modelo no paramétrico  | \(-5,133,520\)            |
| DAG original seleccionada | \(-5,176,757\)            |
...
Galera Capilla, M. I. (2020). Redes bayesianas: fundamentos teóricos y uso en R (Trabajo Fin de Grado, Universidad de Almería). Repositorio Institucional UAL. \url{https://repositorio.ual.es/bitstream/handle/10835/19116/GALERA%20CAPILLA%2C%20MARIA%20ISABEL.pdf?sequence=1&isAllowed=y}

Montesinos López, O. A. (s.f.). Redes Bayesianas. Centro de Investigación en Matemáticas, A.C. \url{https://probayestadistica.cimat.mx/sites/default/files/PDFs/TE414MontesinosLopez.pdf}
