...
```{r}
dag1 = model2network("[h0302][h0303][region][CO|entidad][SO2][valor_HCST][valor_INSULINA|h0302:valor_ALBU][estrato|municipio][municipio|entidad][entidad|region][valor_PCR|valor_HCST:SO2][valor_VIT_B12|valor_HCST:estrato][valor_GLU_SUERO|valor_PCR][valor_COLEST|valor_PCR:valor_INSULINA][valor_VIT_D|h0303:region][valor_HB1AC|valor_INSULINA:valor_ALBU][valor_ALBU|CO][PM10|estrato][hb02|estrato:h0302]") 
```
